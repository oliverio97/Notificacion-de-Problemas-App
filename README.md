# Notificación de Problemas Sede Centro
...
* **Microsoft Dataverse / Tablas personalizadas:** Estructuración del modelo de datos y almacenamiento de los activos.

## Requisitos e Instalación
Para desplegar esta aplicación y sus tablas asociadas en un nuevo entorno de Power Platform:
1. Acceder a [make.powerapps.com](https://make.powerapps.com) y seleccionar el entorno de destino.
2. Navegar a la sección de **Soluciones** en el menú lateral izquierdo.
3. Seleccionar **Importar solución** (Import solution) y cargar el archivo empaquetado `NotificaciondeProblemasSedeCentro_1_0_0_1.zip`.
4. Seguir los pasos del asistente de importación.
5. Una vez que el proceso finalice correctamente, presionar **Publicar todas las personalizaciones** para asegurar que la app y las tablas estén activas.
